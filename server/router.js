...
router.post("/recipes", fileMiddleware, authMiddleware, createRecipe);
router.put("/recipes/:id", fileMiddleware, authMiddleware, updateRecipe);
router.delete("/recipes", authMiddleware, removeRecipe);
